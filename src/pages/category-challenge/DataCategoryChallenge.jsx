...
import AddCategoryChallenge from "./AddCategoryChallenge";
import ModalCategoryChallenge from "../../components/modal/ModalDeleterCategoryChallenge";
import EditCategoryChallenge from "./EditCategoryChallenge";
import DetailCategoryChallenge from "./DetailCategoryChallenge";

const DataCategoryChallenge = () => {
  ...
  const deleteData = async () => {
    try {
      await axios.delete(
        `https://backend-sapajari-sllsn77ftq-et.a.run.app/category-challenge/${selectedData.uuid}`
      );
      setData((prevData) =>
  ...
  return (
    <>
        ...
        <div className="flex justify-end">
          {openAdd ? (
            ...
            <button
              ...
              className="button__primary"
            >
              Tambah Kategori Tantangan
            </button>
          )}
        </div>
        {openAdd ? (
          <AddCategoryChallenge fetchData={fetchData} setOpenAdd={setOpenAdd} />
        ) : null}
      ...
      <DetailCategoryChallenge
        openModal={openModalDetail}
        setOpenModal={setOpenModalDetail}
        data={selectedData}
      />

      <EditCategoryChallenge
...
export default DataCategoryChallenge;
