...
import ModalDeleteNumber from "../../components/modal/ModalDeleteNumber";
import EditNumber from "./EditNumber";
import DetailNumber from "./DetailNumber";
      ...
      <div className="p-4">
        <div className="flex justify-end">
          {openAddNumber ? (
            <>
              <button
                onClick={() => setOpenAddNumber(false)}
        ...
        {openAddNumber ? (
          <AddNumber fetchData={fetchData} setAddNumber={setOpenAddNumber} />
        ) : null}
